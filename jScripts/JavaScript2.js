$(document).ready(function () {
    ...
    $('#carouselExampleControls').on('slid.bs.carousel', function () {
        ...
        if (currentIndex == 1) {
            ...
            $(".text-center").find("#qInstSpan").html("לחץ\\י על התשובה הרלוונטית.");
        ...
        if (currentIndex == 2) {
            ...
            $(".siteInto").find("#qInstQ").html("גרור\\גררי את הסמן בהתאם <b>למצבך הנוכחי</b> בכל אחד מהתחומים הבאים:");
        ...
        if (currentIndex == 3) {
            ...
            $(".siteInto").find("#qInstQ").html("כשאני בהתלבטות, אני מעדיף\\ה לבקש עזרה מ...");
            $(".text-center").find("#qInstSpan").html("לחץ\\י על התשובה הרלוונטית עבורך.");
        ...
        if (currentIndex == 4) {
            ...
            $(".siteInto").find("#qInstQ").html("גרור\\גררי את הסמן בהתאם <b>לשביעות רצונך</b> ממצבך הנוכחי בתחומים הבאים:");
            $(".text-center").find("#qInstSpan").html("");
        ...
        if (currentIndex == 5) {
            ...
            $(".siteInto").find("#qInstQ").html("באיזו מידה את\\ה מרגיש\\ה שאת\\ה יודע\\ת מהן הזכויות המגיעות לך כצעיר\\ה בישראל?");
            $(".text-center").find("#qInstSpan").html("לחץ\\י על התשובה הרלוונטית עבורך.");
            $(".carousel-control-next").show();
            $(".carousel-control-prev").show();
        }
        ...
        if (currentIndex == 6) {
            ...
            $(".siteInto").find("#qInstQ").html("לחץ\\י על הארגונים\\אתרים שאת\\ה מכיר\\ה מתוך הרשימה שלפניך.");
            $(".text-center").find("#qInstSpan").html("");
    ...
    $("#Qfinish").click(function () {
        ...
        $(".siteInto").find("#qInstQ").html("מצוין! עכשיו שאנחנו מכירים אותך יותר, נוכל להכווין אותך...<br/><b>אנו ממליצים לך לבדוק את העמודים הבאים...</b>");
