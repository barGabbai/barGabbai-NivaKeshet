...
$(document).ready(function () {
    ...
    //$('.secondNav > a[href^="#"]').on('click', function (event) {
    //    var target = $(this.getAttribute('href'));
    //    console.log(target);
    //    if (target.length) {
    //        event.preventDefault();
    //        $('#historyPage').animate({
    //            scrollTop: $("#historyPage").scrollTop() + target.offset().top
    //        }, 1000);
    //    }
    //});

    var offset = $('#introAbout').outerHeight();


    $("#img1Nav2").click(function () {
        $('html, body').animate({
            scrollTop: $("#historyPage").position().top-offset
        }, 700);
    ...
    $("#img2Nav2").click(function () {

        $('html, body').animate({
            scrollTop: $("#whoAreWePage").position().top-offset
        }, 700);
    ...
    $("#img3Nav2").click(function () {

        $('html, body').animate({
            scrollTop: $("#numbersPage").position().top - offset
        }, 700);
    ...
    $("#img4Nav2").click(function () {

            $('html, body').animate({
                scrollTop: $("#sayingPage").position().top - offset
            }, 700);
    ...
    $("#img5Nav2").click(function () {

            $('html, body').animate({
                scrollTop: $("#contactPage").position().top - offset
            }, 700);
    ...
    var topOfHistoryDiv = $("#historyPage").offset().top-420;
    var topOfWhoWeAreDiv = $("#whoAreWePage").offset().top - 490;
    var topOfNumbersDiv = $("#numbersPage").offset().top - 490;
    var topOfSayingDiv = $("#sayingPage").offset().top - 490;
    var topOfContactDiv = $("#contactPage").offset().top-500;
    ...
    var url = "https://www.youtube.com/embed/3WUJgKfKBUY";
    ...
    $('.goalsLinkM').on('click', function () {
        $('.goalsWWA').show();
        $('.howItWorksWWA').hide();
    });

    $('.howItWorksLinkM').on('click', function () {
        $('.howItWorksWWA').show();
        $('.goalsWWA').hide();
    });
