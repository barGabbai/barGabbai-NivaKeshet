...
$(document).ready(function () {
    ...
    var offsetHelp = $('#introAbout').outerHeight();
    //var offsetKnow = $('#introAbout').outerHeight();
    ...
    //var topOfPage = $(".innerPagesNav").offset().top+300;


    //$(window).scroll(function () {
    //    if ($(window).scrollTop() <= topOfPage) {
    //        $("#img2InnerNav2-3").css('opacity', '1'); //reached the desired point -- show div
