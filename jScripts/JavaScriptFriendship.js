...
$(document).ready(function () {
    ...
    var offsetKnowM = $('#introAbout').outerHeight() + 10;


    $("#img1InnerNav2-2").click(function () {
        if ($(window).height() < 750) {

            $('html, body').animate({
                scrollTop: $("#dykFriendship").position().top - offsetHelp
            }, 700);
        }
        else {
            $('html, body').animate({
                scrollTop: $("#dykFriendship").position().top - offsetKnow
            }, 700);
        }

        $("#img1InnerNav2-2").css('opacity', '0'); //reached the desired point -- show div

        $("#img2InnerNav2-2").css('opacity', '1');
    });

    $("#img2InnerNav2-2").click(function () {

        $('html, body').animate({
            scrollTop: $("#assistanceFriendship").position().top - offsetHelp
        }, 700);
       $("#img2InnerNav2-2").css('opacity', '0'); //reached the desired point -- show div

       $("#img1InnerNav2-2").css('opacity', '1');
    });


    var topOfdykFriendshipDiv;
    var topOfassistanceFriendshipDiv;


    if ($(window).width() > 750) {
         topOfdykFriendshipDiv = $("#dykFriendship").offset().top - 620;
         topOfassistanceFriendshipDiv = $("#assistanceFriendship").offset().top - 520;

        $(window).scroll(function () {
            if ($(window).scrollTop() > topOfdykFriendshipDiv) { //scrolled past the other div?
                $("#img1InnerNav2-2").css('opacity', '0'); //reached the desired point -- show div

                $("#img2InnerNav2-2").css('opacity', '1');
            }

            if ($(window).scrollTop() > topOfassistanceFriendshipDiv) { //scrolled past the other div?
                $("#img2InnerNav2-2").css('opacity', '0'); //reached the desired point -- show div
         ...
         topOfdykFriendshipDiv = $("#dykFriendship").offset().top - 300;
         topOfassistanceFriendshipDiv = $("#assistanceFriendship").offset().top - 100;
    ...
    $('#exampleFormControlSelect1').on('change', function () {
        ...
        else if ($(this).find("option:selected").attr("id") == "yeruham") {
            $('#nameOfOrg').html("ירוחם");
            $('#contactInfo').show();

            $('#nameOfOperatingPerson').html("נועה פרקש");
            $('#nameOfAddressOfCenter').html("ירוחם");
            $('#nameOfphoneNum').html('052-6633897');
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#linkToEmail').attr('href', 'mailto:noafar123@gmail.com');
            $('#linkToFacebook').attr('href', 'https://www.facebook.com/%D7%9E%D7%95%D7%A2%D7%A6%D7%94-%D7%9E%D7%A7%D7%95%D7%9E%D7%99%D7%AA-%D7%99%D7%A8%D7%95%D7%97%D7%9D-1532181380387819/');
        }

        else if ($(this).find("option:selected").attr("id") == "bneiShimon") {
            $('#nameOfOrg').html("בני שמעון");
            $('#contactInfo').show();

            $('#nameOfOperatingPerson').html("איסילי קמפבל");
            $('#nameOfAddressOfCenter').html("בני שמעון");
            $('#nameOfphoneNum').html('054-7589842');
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#linkToEmail').attr('href', 'mailto:isicampbell25@gmail.com');
            $('#linkToFacebook').attr('href', 'https://www.facebook.com/bns.org.il/');
        }

        else if ($(this).find("option:selected").attr("id") == "shoham") {
            $('#nameOfOrg').html("שוהם");
            $('#contactInfo').show();

            $('#nameOfOperatingPerson').html("אתי זלק");
            $('#nameOfAddressOfCenter').html("שוהם");
            $('#nameOfphoneNum').html('052-4280117');
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#linkToEmail').attr('href', 'mailto:etiz@shoham.muni.il');
            $('#linkToFacebook').attr('href', 'https://www.facebook.com/shoham.isr/');
        }
    ...
    $('#exampleFormControlSelect2').on('change', function () {
        ...
        else if ($(this).find("option:selected").attr("id") == "yeruhamM") {
            $('#nameOfOrgM').html("ירוחם");
            $('#contactInfoM').show();

            $('#nameOfOperatingPersonM').html("נועה פרקש");
            $('#nameOfAddressOfCenterM').html("ירוחם");
            $('#nameOfphoneNumM').html('052-6633897');
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#linkToEmailM').attr('href', 'mailto:noafar123@gmail.com');
            $('#linkToFacebookM').attr('href', 'https://www.facebook.com/%D7%9E%D7%95%D7%A2%D7%A6%D7%94-%D7%9E%D7%A7%D7%95%D7%9E%D7%99%D7%AA-%D7%99%D7%A8%D7%95%D7%97%D7%9D-1532181380387819/');
        }

        else if ($(this).find("option:selected").attr("id") == "bneiShimonM") {
            $('#nameOfOrgM').html("בני שמעון");
            $('#contactInfoM').show();

            $('#nameOfOperatingPersonM').html("איסילי קמפבל");
            $('#nameOfAddressOfCenterM').html("בני שמעון");
            $('#nameOfphoneNumM').html('054-7589842');
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#linkToEmailM').attr('href', 'mailto:isicampbell25@gmail.com');
            $('#linkToFacebookM').attr('href', 'https://www.facebook.com/bns.org.il/');
        }

        else if ($(this).find("option:selected").attr("id") == "shohamM") {
            $('#nameOfOrgM').html("שוהם");
            $('#contactInfoM').show();

            $('#nameOfOperatingPersonM').html("אתי זלק");
            $('#nameOfAddressOfCenterM').html("שוהם");
            $('#nameOfphoneNumM').html('052-4280117');
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#linkToEmailM').attr('href', 'mailto:etiz@shoham.muni.il');
            $('#linkToFacebookM').attr('href', 'https://www.facebook.com/shoham.isr/');
        }
    ...
    $('#exampleFormControlSelect3').on('change', function () {
        ...
        else if ($(this).find("option:selected").attr("id") == "yeruhamM2") {
            $('#nameOfOrgM2').html("ירוחם");
            $('#contactInfoM2').show();

            $('#nameOfOperatingPersonM2').html("נועה פרקש");
            $('#nameOfAddressOfCenterM2').html("ירוחם");
            $('#nameOfphoneNumM2').html('052-6633897');
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#linkToEmailM2').attr('href', 'mailto:noafar123@gmail.com');
            $('#linkToFacebookM2').attr('href', 'https://www.facebook.com/%D7%9E%D7%95%D7%A2%D7%A6%D7%94-%D7%9E%D7%A7%D7%95%D7%9E%D7%99%D7%AA-%D7%99%D7%A8%D7%95%D7%97%D7%9D-1532181380387819/');
        }

        else if ($(this).find("option:selected").attr("id") == "bneiShimonM2") {
            $('#nameOfOrgM2').html("בני שמעון");
            $('#contactInfoM2').show();

            $('#nameOfOperatingPersonM2').html("איסילי קמפבל");
            $('#nameOfAddressOfCenterM2').html("בני שמעון");
            $('#nameOfphoneNumM2').html('054-7589842');
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#linkToEmailM2').attr('href', 'mailto:isicampbell25@gmail.com');
            $('#linkToFacebookM2').attr('href', 'https://www.facebook.com/bns.org.il/');
        }

        else if ($(this).find("option:selected").attr("id") == "shohamM2") {
            $('#nameOfOrgM2').html("שוהם");
            $('#contactInfoM2').show();

            $('#nameOfOperatingPersonM2').html("אתי זלק");
            $('#nameOfAddressOfCenterM2').html("שוהם");
            $('#nameOfphoneNumM2').html('052-4280117');
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#linkToEmailM2').attr('href', 'mailto:etiz@shoham.muni.il');
            $('#linkToFacebookM2').attr('href', 'https://www.facebook.com/shoham.isr/');
        }
