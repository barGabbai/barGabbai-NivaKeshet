...
$(document).ready(function () {
    ...
    //$("#img1InnerNav2-1").click(function () {
    //    if ($(window).height() < 750) {

    //        $('html, body').animate({
    //            scrollTop: $("#dykCareer").position().top - offsetHelp
    //        }, 700);
    //    }
    //    else {
    //        $('html, body').animate({
    //            scrollTop: $("#dykCareer").position().top - offsetKnow
    //        }, 700);
    //    }

    //    $("#img1InnerNav2-1").css('opacity', '0'); //reached the desired point -- show div

    //    $("#img2InnerNav2-1").css('opacity', '1');
    //});

    //$("#img2InnerNav2-1").click(function () {

    //    $('html, body').animate({
    //        scrollTop: $("#assistanceCareer").position().top - offsetHelp
    //    }, 700);
    //    $("#img2InnerNav2-1").css('opacity', '0'); //reached the desired point -- show div

    //    $("#img1InnerNav2-1").css('opacity', '1');
    //});

    //var topOfdykCareerDiv;
    //var topOfassistanceFriendshipDiv;


    //if ($(window).width() > 750) {
    //     topOfdykCareerDiv = $("#dykCareer").offset().top - 620;
    //     topOfassistanceFriendshipDiv = $("#assistanceCareer").offset().top - 520;

    //    $(window).scroll(function () {
    //        if ($(window).scrollTop() > topOfdykCareerDiv) { //scrolled past the other div?
    //            $("#img1InnerNav2-1").css('opacity', '0'); //reached the desired point -- show div
    ...
    //else {
    //     topOfdykFriendshipDiv = $("#dykCareer").offset().top - 300;
    //     topOfassistanceFriendshipDiv = $("#assistanceCareer").offset().top;
